...
- **Global scope**: `/Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/notes/`)
...
2. Glob `/Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/notes/` — works in any directory
