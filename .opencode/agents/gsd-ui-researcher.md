...
Use template from `/Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
