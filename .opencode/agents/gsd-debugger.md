...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode
                  → checks /Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done
                  → writes to /Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done/hooks/
...
@/Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
