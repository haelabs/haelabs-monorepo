...
Intel system is disabled. To activate:
  ...
  node /Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Users/nrgsxjb/.openclaw/workspace-akai/haelabs-monorepo/.opencode/get-shit-done/bin/gsd-tools.cjs
